...
@EndUserText.label: 'Cds For AR Report Agent Wise'
...
define root view entity ZFI_AR_REPORT_AGENT_CDS_FIN 
      with parameters 
                p_comp : abap.char( 4 ) ,
                p_posting1:abap.dats
 as select from ZFI_AR_REPORT_CDS as a    
 inner join I_BillingDocumentPartner as c on ( c.BillingDocument = a.OriginalReferenceDocument and c.PartnerFunction = 'ZA' ) 
