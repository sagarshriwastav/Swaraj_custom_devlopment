@AbapCatalog.sqlViewName: 'YSUMSUPPLIER2'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Cds For Customer Outstanding Report'
define view ZFI_CUSTOMER_WISE_AMT3 with parameters 
                p_comp : abap.char( 4 ) ,
                p_posting:abap.dats,
                ...
                RAMT2:abap.int4,
                RAMT3:abap.int4
as select from ZFI_CUSTOMER_WISE_AMT2( p_comp : $parameters.p_comp, p_posting : $parameters.p_posting, 
