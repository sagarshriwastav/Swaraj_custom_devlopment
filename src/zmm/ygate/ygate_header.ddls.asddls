...
@EndUserText.label: 'parent Header View With Header fields'
define root view entity YGATE_HEADER as select from ygatehead1
composition[0..*] of YGATE_ITEMCDS as _gateitem {
  ...
  local_last_changed_at as LocalLastChangedAt,
    _gateitem // Make association public
}
