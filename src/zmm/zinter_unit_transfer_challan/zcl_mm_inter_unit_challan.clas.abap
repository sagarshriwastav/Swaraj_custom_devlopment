class zcl_mm_inter_unit_challan definition
  public
  create public .
...
CLASS ZCL_MM_INTER_UNIT_CHALLAN IMPLEMENTATION.
...
year = value #( req[ name = 'year' ]-value optional ) .
 ...
 DATA(pdf1) = zmm_interunit_print=>read_posts( matdoc = matdoc year = year )  .
*
