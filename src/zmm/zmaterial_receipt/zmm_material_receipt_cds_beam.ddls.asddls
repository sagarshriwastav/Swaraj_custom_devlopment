 ...
 
 {
  ...
  //      b.MaterialDocumentItem,
       ...
       @Semantics.quantity.unitOfMeasure: 'MaterialBaseUnit'
        case when ( b.GoodsMovementType = '101' or b.GoodsMovementType = '561' ) and q.CharcFromDecimalValue <> 0  then b.QuantityInBaseUnit / cast( q.CharcFromDecimalValue as abap.dec( 13, 3 ) )  
        end as PrBagKg,  
       @Semantics.quantity.unitOfMeasure: 'MaterialBaseUnit'
        case when ( b.GoodsMovementType = '101' or b.GoodsMovementType = '561' ) and s.CharcFromDecimalValue <> 0 then b.QuantityInBaseUnit / cast( s.CharcFromDecimalValue as abap.dec( 13, 3 ) ) 
        end as PrConeKg
} 
