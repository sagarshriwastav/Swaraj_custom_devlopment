...
define root view entity  ZFI_SUPPLIER_WISE_AMT with parameters 
                p_comp : abap.char( 4 ) ,
                p_posting:abap.dats,
                ...
                RAMT2:abap.int4,
                RAMT3:abap.int4
 as select from ZMM_PRODUCT_OUTSTANDING1( p_comp : $parameters.p_comp, p_posting : $parameters.p_posting, 
