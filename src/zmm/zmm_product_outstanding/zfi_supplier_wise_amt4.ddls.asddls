@AbapCatalog.sqlViewName: 'YSUMSUPPLIERAMT4'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Cds For Supplier Outstanding Report'
define view ZFI_SUPPLIER_WISE_AMT4 with parameters 
                p_comp : abap.char( 4 ) ,
                p_posting:abap.dats,
                ...
                RAMT2:abap.int4,
                RAMT3:abap.int4
as select from ZFI_SUPPLIER_WISE_AMT3( p_comp : $parameters.p_comp, p_posting : $parameters.p_posting, 
