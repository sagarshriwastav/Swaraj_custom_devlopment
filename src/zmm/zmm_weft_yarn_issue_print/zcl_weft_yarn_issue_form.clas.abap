CLASS zcl_weft_yarn_issue_form DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_WEFT_YARN_ISSUE_FORM IMPLEMENTATION.
...
*number_of_rolls2 = '16' order = '123432'  ) .
  ...
  METHOD read_posts .
    ...
    SELECT * from  I_MaterialDocumentItem_2 as a
     ...
     WHERE a~MaterialDocument = @matdoc AND a~InventorySpecialStockType = 'F' or a~InventorySpecialStockType = 'O'
     and A~goodsmovementtype = '541' into table @data(item1)  .
...
""""""""""""""""""""""""""""""""""""""""""""""""""""Plant Wise Address, GST & PAN"""""""""""""""""""""""""""""""""""
   ...
   LOOP AT item1 INTO witem.
    ...
    DATA lc_template_name1 TYPE string .
     ...
     lc_template_name1 = 'WEFTYARNISSUE_MM/WEFTYARNISSUE_MM'.
     DATA(lv_xml) =
      |<form1>| &&
   |<Subform1>| &&
      |<Subform1>| &&
...
*     |</Subform5>| &&
   ...
   |<Subform2>| &&
      |<Left>| &&
         ...
         |<PARTYFROMADDR2>{ Register3 }</PARTYFROMADDR2>| &&
