@AbapCatalog.sqlViewName: 'YGREADINGREPOR'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'ZPP_GREADING_REPORT'
define view ZPP_GREADING_REPORT as select from ZPACK_HEAD_REP_CDS as a
                     left outer join zdnmfault as b on ( b.material_number = a.MaterialNumber
                                                        and b.plant = a.Plant and b.mat_doc = a.MatDoc
                                                        and b.mat_docyear = a.MatDocyear ) 
                                                                        ...
                                                                        and a.PostingDate = c.PostingDate )                                   
{
    ...
    key a.MatDocyear,
        ...
        a.Stock,
        a.Delivery,
        cast( b.tometer as abap.dec( 13, 3 )  ) as tometer ,
        b.ftype ,
