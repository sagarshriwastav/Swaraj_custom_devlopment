@AbapCatalog.sqlViewName: 'YAPRTYDMG'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Cds For Party Wise Fault Dmange Mtr'
define view ZPP_PARTY_WISE_DMG_CDS 
  with parameters  
    p_fromdate : abap.dats,
    p_todate   : abap.dats
   as select from ZPACK_HEAD_REP_CDS as a  
   
    left outer join zdnmfault as b on (   b.material_number = a.MaterialNumber and b.plant = a.Plant and b.mat_doc = a.MatDoc
 ...
 
{
   ...
   key a.MaterialNumber,
       a.Setno,
   case when  Party = '' then 'Other' else Party end as Party  ,
