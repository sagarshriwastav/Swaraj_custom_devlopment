@AbapCatalog.sqlViewName: 'YPARTYWISEDMG'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Cds For Party Wise Fault Dmange Mtr'
define view ZPP_PARTY_WISE_DMG_CDS3 
 with parameters  
    p_fromdate : abap.dats,
    p_todate   : abap.dats
    as select from ZPP_PARTY_WISE_DMG_CDS2( p_fromdate : $parameters.p_fromdate , p_todate : $parameters.p_todate )
{
    key Party,
    SortNo,
    Setno,
