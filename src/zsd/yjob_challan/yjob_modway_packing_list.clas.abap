CLASS yjob_modway_packing_list DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS YJOB_MODWAY_PACKING_LIST IMPLEMENTATION.
...
*    DATA(xml)  = read_posts( variable = '0090000017'  )   .
  ...
  METHOD read_posts .
    ...
    if pick is INITIAL .
    template = 'SD_JOB_CHALLAN_MODWAY/SD_JOB_CHALLAN_MODWAY' .
    ELSE .
    template = 'SD_JOB_CHALLAN_MODWAY_PICK/SD_JOB_CHALLAN_MODWAY_PICK' .
    ENDIF.
